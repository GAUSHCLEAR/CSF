...
def set_spacial_frequency_gui(container,distance_in_meter,dpi):
        ...
        T_list_in_cycle_per_deg_text = container.text_input('空间频率（周期/度）', '3,6,12,18,24')
...
def set_contrast_gui(container):
    ...
    logCS_min = container.number_input('最小对比度（logCS）', min_value=0.0, max_value=2.0, value=1.0, step=0.1)
